...
results_file <- file.path(out_dir, "all_results_ctrlRareSep_noSCZrec_sc_26-7-17.tsv")
group_file <- file.path(burden_root, "Supplementary_Table_3_gene_sets_summary.tsv")
out_file <- file.path(out_dir, "all_results_ctrlRareSep_noSCZrec_sc_with_groupwiseFDR_26-7-17.tsv")
summary_file <- file.path(out_dir, "summary_groupwiseFDR_ctrlRareSep_noSCZrec_sc_26-7-17.tsv")
