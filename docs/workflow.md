...
- Exact manuscript-to-script mapping and production commands.
- Which alternative CNV and HLA scripts correspond to primary versus sensitivity analyses.
- Reference file checksums and software versions.
- Cluster resources and licensed dependencies.
- The bulk RNA-seq paired-read argument described in the root README.
- The inversion-clustering assumptions, case-enrichment direction, genotype handling, and representative interval policy.
- Whether the retained IGSR manifest and CHM13 remapping template correspond to the final reference-population analysis.
